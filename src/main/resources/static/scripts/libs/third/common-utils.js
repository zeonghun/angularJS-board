 ...
 * @returns 
 * 
 * @author jwlee(jwlee_at_ymtech_co_kr)
 * @since 2015. 8. 25.
 */
...
CommonUtils.isNotNullNumber = function(val) {
	
	return (val == undefined || val == null || isNaN(val)) ? true : false;
};
...
CommonUtils.getTimestampToString = function(input, format) {
	var result = null;
	var date = new Date(input);
